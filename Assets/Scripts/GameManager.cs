...
public class GameManager : MonoBehaviour {
    ...
    public Animator borraButtonAnimator;
    ...
    public void StartGame() {
        ...
        borraButton.GetComponent<Button>().interactable = false;
        imagen.SetActive(false);
        ...
        if (startButton.activeSelf == true) {
            ...
            borraButtonAnimator.SetTrigger("FadeIn");
        }
